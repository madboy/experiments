...
First out looking through "Klassisk och modern nöjesmatematik" by Paul Vaderlind. The best match I can find is alphametics, for example "send + more = money", see [alphametic1.py](implementation). Even though it includes reasoning to get the answer I cannot see a good way to implement it as a guessing game. And it's probably better as an individual puzzle.
